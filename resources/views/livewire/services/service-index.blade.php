<div>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mb-1 p-1">
        ...
        <div class="grid grid-cols-3 gap-1">
            ...
            <div class='col-span-3 md:col-span-1'>
                <a href="{{ route('services.create') }}" title="Clique para cadastrar novo registro" class="bg-green-600 hover:bg-green-900 px-4 py-2 text-white rounded text-center block md:w-44 md:float-right">
                    Novo Registro
                </a>
            </div>
        </div>
