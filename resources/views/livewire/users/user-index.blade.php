    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mb-1 p-1">
        ...
        <div class="grid grid-cols-3 gap-1">
            <div class='col-span-3 md:col-span-1'>
                ...
                <input type="text" wire:model="search" value="{{ $search }}" id="name" maxlength="20" placeholder="Buscar..." class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm w-full md:w-52" />
            </div>
            <div class='col-span-3 md:col-span-1'>
                
            </div>
            <div class='col-span-3 md:col-span-1'>
                <a href="{{ route('users.create') }}" title="Clique para cadastrar novo registro" class="bg-green-600 hover:bg-green-900 px-4 py-2 text-white rounded text-center block md:w-44 md:float-right">
                    Novo Registro
                </a>
            </div>
        </div>
