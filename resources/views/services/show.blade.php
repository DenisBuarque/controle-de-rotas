<x-app-layout>
    ...
    <div class="py-3">
        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8 bg-white mt-28 py-5 rounded shadow text-center">
            ...
            <h3 class='mb-5 text-xl'>Deseja mesmo excluir o registro {{ $service->name }}?</h3>
            ...
            <form action="{{ route('services.delete', $service->id) }}" method="POST">
                @csrf
                @method('DELETE')
                <a href="{{ route('services.index') }}" class='border-gray-300 border-2 text-center px-5 py-3 rounded'>Não, obrigado!</a>
